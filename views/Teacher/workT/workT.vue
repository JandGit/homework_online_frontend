<template>
    <div class="wrapper">
        <div class="paper">
            ...
            <span v-if="mark == 2|3" style="text-align: left; display: block; float: right">{{this.paper.stu_name}}</span>
            <br><br>
            <div class="topics">
                <!-- :index = "topic.index" -->
                ...
                <topic v-for="(topic, index) in paper.questions"
                    ...
                    :answerValueS = "topic.answer.choice.stu_answer"
                    >
                </topic>
                <br><br>
                <div v-if="this.paper.status == 'unchecked'">
                    <span style="line-height: 50px;">批注：</span>
                    <el-input v-model="paper.comment" type="textarea" :autosize="{ minRows: 2, maxRows: 4}" style="width: 500px;"></el-input>
                    <br><br>
                    <span>分数：</span>
            ...
            <el-button v-if="mark == 0" class="submit" v-on:click="dialogVisible = true" size="large" type="success" :disabled="this.btnDisabled">
                    发布作业
            </el-button>
            <el-button v-if="mark == 2" class="submit" v-on:click="dialogVisible = true" size="large" type="success" :disabled="this.btnDisabled">
                    批改完成
            </el-button>
